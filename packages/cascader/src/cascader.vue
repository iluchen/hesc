...
<script>
import Popper from 'hesc-ui/src/utils/vue-popper';
import Clickoutside from 'hesc-ui/src/utils/clickoutside';
import Emitter from 'hesc-ui/src/mixins/emitter';
import Locale from 'hesc-ui/src/mixins/locale';
import Migrating from 'hesc-ui/src/mixins/migrating';
import ElInput from 'hesc-ui/packages/input';
import ElTag from 'hesc-ui/packages/tag';
import ElScrollbar from 'hesc-ui/packages/scrollbar';
import ElCascaderPanel from 'hesc-ui/packages/cascader-panel';
import AriaUtils from 'hesc-ui/src/utils/aria-utils';
import { t } from 'hesc-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'hesc-ui/src/utils/util';
import { isUndefined, isFunction } from 'hesc-ui/src/utils/types';
import { isDef } from 'hesc-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'hesc-ui/src/utils/resize-event';
